 ...
 */
public class CreateAccountAcitivity extends BaseActivity {
    private static final String LOG_TAG = CreateAccountAcitivity.class.getSimpleName();
    ...
    public void onSignInPressed(View view) {
        Intent intent = new Intent(CreateAccountAcitivity.this, LoginActivity.class);
                    ...
                    public void onSuccess() {
                        ...
                        mFirebaseRef.authWithPassword(mUserEmail, mPassword, new Firebase.AuthResultHandler() {
                            ...
                            public void onAuthenticated(AuthData authData) {
                                ...
                                SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(CreateAccountAcitivity.this);
    ...
    private void showErrorToast(String message) {
        Toast.makeText(CreateAccountAcitivity.this, message, Toast.LENGTH_LONG).show();
    }
}